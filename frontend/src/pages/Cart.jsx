...
function Cart() {
  ...
  }, [cardItems, products])//before loadingdata executing function
  return (
      ...
      <div>
        {
          cartData.map((item, index) => {
            ...
            return (
              <div key={index} className='py-4 border-t border-b text-gray-700 grid grid-cols-[4frf_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4  '>
