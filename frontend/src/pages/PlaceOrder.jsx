...
function PlaceOrder() {
 ...
 const {navigate,backendUrl,token,cardItems,setCardItems,getCartAmount,delivery_fee,products}=useContext(ShopContext);
  ...
  try {
      ...
      for(const items in cardItems){
        for(const item in cardItems[items]){
          if (cardItems[items][item]>0) {//product is in cart
...
<div className='fex gap-3 flex-col lg:flex-row'>
